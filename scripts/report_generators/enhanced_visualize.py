...
Usage: python3 scripts/report_generators/enhanced_visualize.py <generated_reports_dir>
...
✅ Sensor → Middleware: {format_ms_to_readable(s2m_mean_avg)}
❌ Middleware → Simulator: {format_ms_to_readable(m2s_mean_avg)}

Target: < 1ms
Problem: M2S latency {m2s_mean_avg/s2m_mean_avg:.0f}x higher than S2M
        """
